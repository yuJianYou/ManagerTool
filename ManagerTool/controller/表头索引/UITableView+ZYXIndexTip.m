...
-(UILabel *)indexTipLabel{
    if(nil == _indexTipLabel){
        ...
        _indexTipLabel.layer.cornerRadius = _indexTipLabel.frame.size.height/2;
        _indexTipLabel.clipsToBounds = YES;
        _indexTipLabel.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.3];
        _indexTipLabel.textAlignment = NSTextAlignmentCenter;
        _indexTipLabel.textColor = [UIColor whiteColor];
        _indexTipLabel.font = [UIFont systemFontOfSize:20];
    }
